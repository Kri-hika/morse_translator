...
import 'package:morse_translator/Translations.dart';
...
class TranslatorPage1 extends StatefulWidget {
  @override
  _TranslatorPage1State createState() => _TranslatorPage1State();
}

class _TranslatorPage1State extends State<TranslatorPage1> {
  var b;
             ...
             child: Container(
               ...
               children: <Widget>[
                 ...
                 ListTile(
                   ...
                   title: Text('Mode Switch',style: TextStyle(fontSize: 24.0,
                     // ignore: deprecated_member_use
                     color: Theme.of(context).textTheme.title.color,)),
                  ...
                  children: [
                            ...
                            children: [
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  // ignore: deprecated_member_use
                                  hintStyle: TextStyle(fontSize: 25,color: Theme.of(context).textTheme.title.color),
                              ...
                              Padding(
                                ...
                                child: MaterialButton(onPressed: (){
                                  setState(() {
                                    b = morse.decode(inputcontroller.text);
                                    setState(() {
                                      message = b;
                                    });
                                  });
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          MaterialButton(
                            onPressed: () =>Navigator.push(context,MaterialPageRoute(builder: (BuildContext ctx) =>FactsPage())),
                            color: Theme.of(context).colorScheme.primaryVariant,
                            height: 70.0,
                            minWidth: 140.0,
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(18.0),),
                            // ignore: deprecated_member_use
                            child:Text('Facts', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500,color : Theme.of(context).textTheme.title.color,), textAlign:TextAlign.center,),
                          ),
                          SizedBox(
                            width: 131.0,
                          ),
                          MaterialButton(
                            onPressed: () => Navigator.push(context,MaterialPageRoute(builder: (BuildContext ctx) =>HistoryPage())),
                            color: Theme.of(context).colorScheme.primaryVariant,
                            height: 70.0,
                            minWidth: 140.0,
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(18.0),),
                            // ignore: deprecated_member_use
                            child:Text('History', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500,color : Theme.of(context).textTheme.title.color,), textAlign:TextAlign.center,),
                          ),
                        ],
                      ),
                    ),
